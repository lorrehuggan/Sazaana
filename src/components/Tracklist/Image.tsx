...
export default function AlbumImage({ track }: IAlbumImageProps) {
  return (
    <Link href={track.data.trackURL}>
      <div className="transform-transition group relative h-16 w-16 cursor-pointer overflow-hidden rounded-xl shadow lg:h-20 lg:w-20 lg:hover:-translate-y-2 lg:hover:rotate-2 xl:h-28 xl:w-28">
